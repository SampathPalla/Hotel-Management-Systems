<%-- 
    Document   : FallFinancialAnalysis
    Created on : Apr 12, 2015, 8:17:06 PM
    Author     : SampathYadav
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                ...
                <% } %>
                // Set chart options
                var options = {'title': "Fall Statistics for the year " + "<%=yearSelected%>",
                               'width':500,
                               'height':500};
                var chart = null;
    ...
    <body>
        <div class="container" id="ownerHome">
            <ul class="nav nav-tabs nav-justified" id="tabAnalysis">
                <li class="active" id="liFall">
                    <a href="#tab-FallAnalysis" data-toggle="tab" onclick="drawChart()"><span class="glyphicon glyphicon-calendar"></span>   
                        <span>Fall</span>
                    </a>
                </li>
            </ul>
