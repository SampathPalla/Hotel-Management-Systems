...
<html>
    <head>
        ...
        <title>Grant Employee Privileges</title>
        ...
        <script type="text/javascript">
            function grantEmpPriv() {
                ...
                <%
                    ...
                    {
                        rst1 = stmt.executeQuery ("update login set UserType='E' where loginid='"+yearSelected+"'");
                    }
                    else
                    {
                                    ...
                                    <table style="width:100%">
                                        <tr>
                                            <td style="width: 50%">
                                                ...
                                                <br>
                                                <input type="submit" value="Grant Employee Privilege" id="btnGenerateYearly" Name="btnGenerateYearly" onclick="grantEmpPriv()">
                                            </td>
