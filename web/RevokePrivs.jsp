...
<html>
    <head>
        ...
        <title>Revoke All Privileges</title>
        ...
        <script type="text/javascript">
            function grantEmpPriv() {
                ...
                <%
                    ...
                    {
                        rst1 = stmt.executeQuery ("update login set UserType='G' where loginid='"+yearSelected+"'");
                    }
                    else
                    {
                                    ...
                                    <table style="width:100%">
                                        <tr>
                                            <td style="width: 50%">
                                                ...
                                                <br>
                                                <input type="submit" value="Revoke All Privilege" id="btnGenerateYearly" Name="btnGenerateYearly" onclick="grantEmpPriv()">
                                            </td>
